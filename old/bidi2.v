...
match text with
  | nil => nil
  | NSM :: text' => prev :: rule_w1 prev text'
  | c :: text' => c :: rule_w1 c text'
end.

(* W2: Search backward from each instance of a European number until the first strong type (R, L, AL, or sor) is found. If an AL is found, change the type of the European number to Arabic number. *)
(* AL [^R L AL]* [EN -> AN] *)
Fixpoint rule_w2 (is_al : bool) (text : list bidi_class) :=
match text with
| nil => nil
...
SequenceOfEuropeanNumbers "(EN+ sep-by (ES|CS)) bracket-by ET*".
ArabicNumber "AN+ sep-by CS".
EuroArabicNumber "(AN|EN)+ sep-by CS".
...
Remaining L,R,AN,ON,EN

After

Fixpoint w_all after_al after_l
match after_al, text with
| L
| R
| AL

(* AN *)
| _, AN :: text' | CS :: ((AN :: _) as text') => AN :: rec

(* EAN *)
| , EN :: text' | CS :: ((EN :: _) as text') => AN :: rec

(* SoEN *)
| false EN :: text' | ES :: (EN :: _) | CS :: (EN :: _) | ET :: _
| false ET :: _ and will_have_EN
